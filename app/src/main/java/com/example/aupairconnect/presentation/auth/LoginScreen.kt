...
fun LoginScreen(
    ...
    var hasFinishedLoading = remember { mutableStateOf(false) }
...
//        )
    ...
    if (hasFinishedLoading.value) {
        Column(modifier = Modifier
            ...
            }){ Text(text = "Check Current User & Sign Out")}
            Button(onClick = {
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center, modifier = Modifier.fillMaxHeight()){
            com.example.aupairconnect.presentation.components.RoundedImage(painterResource(id = R.drawable.aupairconnectlogo))
        }
    }
